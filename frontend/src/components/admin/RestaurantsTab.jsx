...
import { Store, RefreshCw, CheckCircle, XCircle, Edit, Trash2 } from 'lucide-react';
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-800">{restaurants.length}</p>
            </div>
                ...
                <tr key={restaurant._id || restaurant.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex space-x-2">
                      ...
                      <button className="text-red-600 hover:text-red-800 text-sm font-medium" title="Delete">
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </td>
